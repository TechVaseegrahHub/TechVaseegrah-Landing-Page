...
//   const roadmap1Opacity = useTransform(scrollYProgress, [0, 0.5, 0.7], [1, 1, 0]);
//   const roadmap2Opacity = useTransform(scrollYProgress, [0.4, 0.6, 1], [0, 1, 1]);
//   const roadmap2Y = useTransform(scrollYProgress, [0.4, 0.6], [200, 0]);

//   return (
//     <section ref={ref} className="relative bg-white">
//       <div className="h-[220vh] relative"> {/* made section taller */}
...
//             src={roadmap1.src}
//             alt="Roadmap 1"
//             className="w-[950px] max-w-[95%] rounded-xl shadow-2xl" // slightly bigger, but safe
//           />
//         </motion.div>
...
//       {/* Extra space so next section doesn't overlap */}
...
//   // Roadmap 1 fades out a bit earlier
//   const roadmap1Opacity = useTransform(scrollYProgress, [0, 0.4, 0.6], [1, 1, 0]);

//   // Roadmap 2 appears earlier
//   const roadmap2Opacity = useTransform(scrollYProgress, [0.35, 0.55, 1], [0, 1, 1]);
//   const roadmap2Y = useTransform(scrollYProgress, [0.35, 0.55], [150, 0]); // less movement

//   return (
//     <section ref={ref} className="relative bg-white">
//       <div className="h-[200vh] relative"> {/* slightly reduced height */}
