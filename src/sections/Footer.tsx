...
const FooterLink = ({ href, children, onClick }: FooterLinkProps) => (
  <li>
    <Link
      href={href}
      onClick={onClick}
      className="hover:text-green-500 transition-colors duration-300 text-sm inline-block py-1.5"
      style={{ color: "#8CB43F" }}
    >
      {children}
    </Link>
...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black py-10">
      <div className="container mx-auto px-5 max-w-6xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8">
          {/* Logo & Description */}
          <div className="flex flex-col sm:items-start col-span-1 sm:col-span-2 lg:col-span-4 lg:pr-6">
            <div className="flex flex-col sm:flex-row lg:flex-col items-center sm:items-start gap-4 sm:gap-5 lg:gap-4">
              ...
              <p className="text-sm max-w-xs text-center sm:text-left" style={{ color: "#8CB43F" }}>
                Innovative technology solutions for modern businesses.
              </p>
          ...
          {/* Company Section */}
          <div className="lg:col-span-2 sm:mt-2">
            <h3 className="font-medium mb-3 text-base tracking-wide" style={{ color: "#4CAF50" }}>Company</h3>
            <ul className="space-y-1">
              {[
                { name: "About", href: "/about" },
                { name: "Careers", href: "/internship" },
          ...
          {/* Resources Section */}
          <div className="lg:col-span-3 sm:mt-2">
            <h3 className="font-medium mb-3 text-base tracking-wide" style={{ color: "#4CAF50" }}>Resources</h3>
            <ul className="space-y-1">
              {[
                { name: "Blog", href: "/blog" },
                { name: "Case Study", href: "/casestudies" },
          ...
          {/* Legal Section */}
          <div className="lg:col-span-3 sm:mt-2">
            <h3 className="font-medium mb-3 text-base tracking-wide" style={{ color: "#4CAF50" }}>Legal</h3>
            <ul className="space-y-1">
              <FooterLink href="/privacy">Privacy Policy</FooterLink>
              <FooterLink href="/terms">Terms of Service</FooterLink>
              <FooterLink
        ...
        {/* Footer Bottom */}
        <div className="mt-10 pt-5 border-t border-gray-800/30 flex justify-end">
          <p className="text-xs text-right" style={{ color: "#8CB43F" }}>
            &copy; {new Date().getFullYear()} Tech Vaseegrah, Inc. All rights reserved.
          </p>
        </div>
      ...
      <AnimatePresence>
        {showScrollButton && (
          <motion.button
            className="fixed bottom-5 right-5 bg-gray-800/60 backdrop-blur-sm p-2 rounded-full shadow-sm hover:bg-gray-700 transition-colors duration-300 z-50"
            onClick={scrollToTop}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            initial={{ opacity: 0, y: 15 }}
