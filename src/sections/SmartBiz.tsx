...
      <motion.div variants={heroVariant} initial="start" animate={isInView ? "end" : "start"} className="container">
        <div className="flex items-center justify-center">
          <p className=" section-title sm:text-3xl md:text-4xl lg:text-5xl  text-black text-center">
            Transforming small businesses into{" "}
            <span className="relative">
              <span className="group inline-block">
                <span style={{ color: TECH_GREEN }} className="bg-clip-text text-transparent animate-pulse">
                  Smart biz
                </span>
                <video
                  src="/assets/incredible.mp4"
