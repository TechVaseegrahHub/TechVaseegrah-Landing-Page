    ...
    return (
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        <div className="space-y-6 md:space-y-8">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight  text-green-600  bg-clip-text">Our values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Be world-class</h3>
            ...
            {/* Value 2 */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Share everything you know</h3>
              <p className="text-black font-body">
            ...
            {/* Value 3 */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Always learning</h3>
              <p className="text-black font-body">
            ...
            {/* Value 4 */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Be supportive</h3>
              <p className="text-black font-body">
            ...
            {/* Value 5 */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Take responsibility</h3>
              <p className="text-black font-body">
            ...
            {/* Value 6 */}
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-green-600">Enjoy downtime</h3>
              <p className="text-black font-body">
