...
const TestimonialsColumn = (props) => (
  <div className={twMerge("testimonial-column", props.className)}>
    <motion.div
      animate={{
        translateY: "-50%",
      }}
        ...
        <React.Fragment key={index}>
          {props.testimonials.map(({ text, imageSrc, name, username }) => (
            <div key={name} className="card">
              <div style={{ color: BLACK_TEXT }}>{text}</div>{" "}
              <div className="flex items-center gap-2 mt-5">
                <Image
                  src={imageSrc}
                  alt={name}
    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="section-heading text-center">
          ...
          <h2
            className="section-title text-4xl font-bold mt-5"
            style={{ color: TECH_GREEN }}
          >
            What our users say
          </h2>
          <p
            className="section-description mt-5 text-lg"
            style={{ color: BLACK_TEXT }}
          >
            From intuitive design to powerful features, our app has become an
            essential tool for users around the world.
