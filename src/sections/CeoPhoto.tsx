...
function CeoPhoto() {
  return (
    <>
      <div className='w-[400px] relative mt-4 h-[430px] group mx-auto dark:bg-black  bg-white dark:border-0 border rounded-md dark:text-white text-black flex flex-col ml-16'>
        <div className='w-full  rounded-t-md h-[350px] group-hover:h-[410px] overflow-hidden transition-all duration-300'>
          <Image
            src={'/sreeKarrthiyen.jpg'}
            alt='shoes'
            width={600}
            height={600}
        ...
        <article className='relative overflow-hidden  flex-grow'>
          <div className='info p-2 translate-y-0 group-hover:-translate-y-20 transition-all duration-300'>
            <p className='md:text-2xl font-semibold'>Mr. SreeKarrthiyen Mahadevan</p>
            <p className='sm:text-base text-sm'>CEO &amp; Founder</p>
          </div>
