...
export const WebHead = () => {
  ...
  // ✅ heroBannerRef is now actually used
  const { scrollYProgress } = useScroll({
    target: heroBannerRef,
    offset: ["start 1080px", "50% start"],
  });
  ...
  return (
    ...
    >
      <motion.div
        ref={heroBannerRef} // ✅ attached here to fix hydration
      ...
      >
        <div className="section-heading">
          ...
          <motion.p
            variants={heroChildVariant}
            className="section-description mt-5 mb-8"
          >
            Unlock the full potential of your business with our specialized website
            development services for superior functionality, flexibility, and
            scalability
          </motion.p>
        </div>
