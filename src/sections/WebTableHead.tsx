...
export const WebTableHead = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: heroBannerRef, // ✅ now this will be hydrated
    offset: ["start 1080px", "50% start"],
  });
  ...
  return (
    <section ref={sectionRef} className="pt-20 pb-24 overflow-x-clip">
      <motion.div
        ref={heroBannerRef} // ✅ added here
