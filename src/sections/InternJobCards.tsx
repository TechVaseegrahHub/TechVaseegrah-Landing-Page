...
const cardData = [
  ...
  {
    image: "/assets/images/ui-ux-eye.png",
  ...
  {
    image: "/assets/images/data-sci.png",
              ...
              {cardData.map(({ image, title, description, color }, cardIndex) => (
                ...
                >
                  ...
                  <div className={twMerge("absolute inset-0 rounded-2xl bg-opacity-40 -z-10 blur-2xl opacity-0 group-hover:opacity-50 transition duration-300",
                    ...
                    color === "fuchsia" && "bg-blue-800",
                    color === "lime" && "bg-blue-800",
                    color === "cyan" && "bg-blue-800",
                    color === "violet" && "bg-blue-800"
                  )}></div>
                  ...
                  <div className="flex justify-center mt-1">
                    <button className="btn-primary btn text-[15px] mt-4 flex flex-col h-full">Apply</button>
                  </div>
                </motion.div>
              ))}
            </motion.div>
