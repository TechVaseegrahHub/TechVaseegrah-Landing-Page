...
const Dropdown = ({ title, isActive, onMouseEnter, onMouseLeave, onClick, onDoubleClick, children }: DropdownProps) => {
  return (
    <div className="relative h-full flex items-center" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      <button
        className="flex items-center gap-1 text-base font-medium text-[#006400] hover:text-[#004d00] transition-colors h-full px-1"
        aria-expanded={isActive}
        aria-haspopup="true"
        onClick={onClick}
        onDoubleClick={onDoubleClick}
...
const MobileNavItem: React.FC<MobileNavItemProps> = ({ href, onClick, children, className, target, rel }) => (
  ...
  >
    <Link
      ...
      target={target}
      rel={rel}
      className={`block py-4 px-5 text-2xl font-medium text-[#006400] rounded-lg transition-colors duration-200 ${className || ""}`}
    >
      {children}
    </Link>
  </motion.div>
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div className="flex flex-col space-y-3 mt-4">
            <MobileNavItem href="/" onClick={onClose} className="text-xl font-medium text-[#006400]">
              Home
            </MobileNavItem>
            ...
            <motion.div className="flex flex-col">
              <motion.button
                ...
                className={`flex items-center justify-between py-3 px-5 text-xl font-medium rounded-lg text-[#006400] ${
                  openCategory === "products" ? "text-[#004d00]" : ""
                }`}
              >
                <span>Products</span>
                <motion.span
            ...
            <motion.div className="flex flex-col mb-20">
              <motion.button
                onClick={() => setOpenCategory(openCategory === "solutions" ? null : "solutions")}
                className={`flex items-center justify-between py-3 px-5 text-xl font-medium rounded-lg text-[#006400] ${
                  openCategory === "solutions" ? "text-[#004d00]" : ""
                }`}
              >
                <span>Solutions</span>
                <motion.span
            ...
            <motion.div className="flex flex-col">
              <motion.button
                onClick={() => setOpenCategory(openCategory === "internships" ? null : "internships")}
                className={`flex items-center justify-between py-3 px-5 text-xl font-medium rounded-lg text-[#006400] ${
                  openCategory === "internships" ? "text-[#004d00]" : ""
                }`}
              >
                <span>Internships</span>
                <motion.span
            ...
            <MobileNavItem href="/about" onClick={onClose} className="text-xl font-medium text-[#006400]">
              About 
            </MobileNavItem>
            ...
            >
              <Link href="/contact" className="block w-full">
                <motion.button
                  onClick={onClose}
                  className="w-full bg-[#006400] hover:bg-[#004d00] text-white py-3 px-2 rounded-lg font-semibold text-xl shadow-md transition-colors"
                  whileTap={{ scale: 0.98 }}
                >
                  Contact
                </motion.button>
        ...
        <div className="container mx-auto px-2 sm:px-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-7 h-full">
              <Link
                href="/"
                className="text-base font-medium text-[#006400] hover:text-[#004d00] transition-colors h-full flex items-center px-1"
              >
                Home
              </Link>
              ...
              <Link href="/contact" className="inline-block">
                <button
                  onClick={closeAll}
                  className="bg-[#006400] hover:bg-[#004d00] text-white rounded-lg font-medium tracking-tight transition-all duration-200 h-10 px-6 py-3 w-30 flex items-center justify-center"
                >
                  Contact
                </button>
              </Link>
