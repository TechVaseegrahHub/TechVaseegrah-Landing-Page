...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Business owners looking to scale their ventures, Entrepreneurs planning to launch a startup, MBA aspirants wanting practical exposure, Working professionals seeking a career transition",
  },
  {
  ...
  return (
    <section className="w-full max-w-4xl mx-auto py-16 px-4 sm:px-6">
      <div className="text-center mb-12">
        <h2 className="section-title mt-8 mb-6">FAQs about SEO services</h2>
