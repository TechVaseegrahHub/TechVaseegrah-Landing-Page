...
export default function SocialScroll() {
  ...
  const services: SEOService[] = [
    ...
    },
    {
      ...
      description:
        "Our content blends strategy with creativity. From viral Instagram Reels, polished carousels, and LinkedIn thought-leadership posts, to captions that prompt action we give your brand a voice that gets attention and earns trust.",
    ...
    },
    {
      ...
      description:
        "Partner with trusted voices who already speak to your audience. We identify the right creators, manage the campaign, and help you grow brand awareness faster with authenticity and impact.",
