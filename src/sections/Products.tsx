...
// const HOVER_GREEN = "rgba(76,175,80,0.5)";
// const CARD_BACKGROUND_COLOR = "#F4FDF4";
...
//           <motion.div variants={tagVariants}>
//             <div
//               className="tag px-4 py-2 rounded-full font-semibold"
...
//             {/* <Tag>Products</Tag> */}
//           </motion.div>
//           <motion.h2 className="section-title mt-5" variants={headerVariants} style={{ color: TECH_GREEN }}>
//             Our Major Products for <br className="hidden md:block" /> E‑commerce Industry
//           </motion.h2>
//         </motion.div>
...
//                   <FeatureCard
//                     title={card.title}
//                     titleColor={card.id === "gowhats" ? TECH_GREEN : BLACK_TEXT} // Apply green to GoWhats title
//                     description={card.description}
//                     descriptionColor={BLACK_TEXT} // Keep description black
//                     button={card.learnMoreLink}
//                     buttonColor={TECH_GREEN} // Apply green to all buttons
//                     className={`z-10 pt-4 md:pt-6 w-full group rounded-2xl transition-shadow duration-300 ease-in-out h-full`}
//                     style={{
...
//                 className="bg-neutral-100 border border-white/10 inline-flex px-2 md:px-5 py-1 md:py-2 rounded-2xl gap-2 md:gap-3 items-center transition-none"
//               >
//                 <span className="text-white w-4 h-4 md:w-5 md:h-5 rounded-full inline-flex items-center justify-center text-base md:text-lg"
//                       style={{ backgroundColor: TECH_GREEN }}>
//                   &#10038;
//                 </span>
//                 <span className="font-medium text-sm md:text-lg" style={{ color: BLACK_TEXT }}>{feature}</span>
//               </motion.div>
//             ))}
//           </motion.div>
//         </div>
...
//                   <FeatureCard
//                     title={card.title}
//                     titleColor={TECH_GREEN} // ✅ all headings green
//                     description={card.description}
//                     descriptionColor={BLACK_TEXT} // ✅ all paragraph black
//                     button={card.learnMoreLink}
//                     buttonColor={TECH_GREEN} // ✅ all buttons green
//                     className={`z-10 pt-4 md:pt-6 w-full group rounded-2xl transition-shadow duration-300 ease-in-out h-full`}
//                     style={{
//                       '--hover-color': HOVER_GREEN,
//                       border: "1px solid transparent",
...
//                   <FeatureCard
//                     title={card.title}
//                     titleColor={TECH_GREEN} // Green color for headings
//                     description={card.description}
//                     descriptionColor={BLACK_TEXT} // Black color for paragraphs
//                     button={card.learnMoreLink}
//                     buttonColor={TECH_GREEN} // Green color for buttons
//                     className={`force-green-styling z-10 pt-4 md:pt-6 w-full group rounded-2xl transition-shadow duration-300 ease-in-out h-full`}
//                     style={{
//                       '--hover-color': HOVER_GREEN,
//                       border: "1px solid transparent",
//                       backgroundColor: CARD_BACKGROUND_COLOR
...
//           /* FORCE GREEN HEADINGS - Multiple selectors to override any existing styles */
//           .force-green-styling h1,
//           .force-green-styling h2,
//           .force-green-styling h3,
//           .force-green-styling h4,
//           .force-green-styling h5,
//           .force-green-styling h6,
//           .force-green-styling .title,
//           .force-green-styling .heading,
//           .force-green-styling [class*="title"],
//           .force-green-styling [class*="heading"] {
//             color: #006400 !important;
//           }
          
//           /* FORCE BLACK PARAGRAPHS */
//           .force-green-styling p,
//           .force-green-styling .description,
//           .force-green-styling .text,
//           .force-green-styling span:not(.bg-neutral-100 span),
//           .force-green-styling div:not(.bg-neutral-100):not(.aspect-video) {
//             color: #000000 !important;
//           }
          
//           /* FORCE GREEN BUTTONS - Multiple selectors for different button types */
//           .force-green-styling button,
//           .force-green-styling a[href],
//           .force-green-styling .button,
//           .force-green-styling .btn,
//           .force-green-styling [role="button"],
//           .force-green-styling .learn-more,
//           .force-green-styling [class*="button"],
//           .force-green-styling [class*="btn"] {
//             color: #006400 !important;
//             border-color: #006400 !important;
//             background-color: #006400 !important;
//           }
          
//           /* If buttons should have green text on transparent/white background */
//           .force-green-styling button.outline,
//           .force-green-styling a.outline,
//           .force-green-styling .button.outline {
//             color: #006400 !important;
...
//           /* Override any existing button hover states */
//           .force-green-styling button:hover,
//           .force-green-styling a:hover {
    ...
    <section className="py-12 md:py-20 bg-white overflow-hidden" ref={sectionRef}>
      <div className="container max-w-7xl mx-auto px-4 md:px-8">
        ...
        <style jsx global>{`
          ...
          /* FORCE GREEN BUTTONS with WHITE TEXT */
          .force-green-styling button,
          .force-green-styling a[href],
          .force-green-styling .button,
          .force-green-styling .btn,
