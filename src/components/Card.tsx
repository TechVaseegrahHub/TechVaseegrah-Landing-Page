...
export const Card = (props: ComponentPropsWithoutRef<"div"> & { color?: string; buttonText?: string }) => {
  ...
  return (
    <div className={twMerge("relative z-0 p-8 md:p-10  group", className)}>
      ...
      <div className="absolute inset-0 bg-zinc-800 -z-10 rounded-2xl border border-zinc-700"></div>
      <div>{children}</div>
      <div className="flex justify-between mt-12">
        ...
        <svg
          ...
          strokeWidth={2}
          stroke="currentColor"
          className="size-8 text-zinc-500 group-hover:text-zinc-300
        transition duration-300 -translate-x-2 group-hover:translate-x-0"
        >
